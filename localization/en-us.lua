return {
    descriptions={
        ...
        Blind={
            ...
            bl_final_acorn={
                name="IM DOIN WHIPPETS",
                text={
                    "IM CRASHING OUT",
                },
            },
            bl_final_bell={
                name="I DIDNT HEAR NO BELL",
                text={
                    "YOU CANNOT PUT THAT SHIT DOWN",
                },
            },
            bl_final_heart={
                name="i miss her",
        ...
        Joker={
            ...
            j_blueprint={
                ...
                text={
                    "Copies ability of",
                    "{C:attention}Jorker{} to the right",
                },
                unlock={
                    "Win a run",
                },
            ...
            j_chicot={
                name="Chicora",
                text={
                    "by the power of the {C:legendary}Grippy Socks{}",
                    "the boss blinds are no more",
            ...
            j_invisible={
                ...
                unlock={
                    "Win a run without",
                    "ever having more",
                    "than {E:1,C:attention}4 Jorkers{}",
                },
            },
            j_joker={
                name="Jimbo",
            ...
            j_riff_raff={
                name="fella",
                text={
                    "You cannot {C:attention}Run{}",
                    "You cannot {C:attention}Hide{}",
            ...
            j_stencil={
                ...
                text={
                    ...
                    "empty {C:attention}Jorker{} slot",
                    "{s:0.8}Jorker Stencil included",
            ...
            j_triboulet={
                name="Triboulea",
                text={
                    "this {C:legendary}Bitch{} makes all Played {C:attention}Kings{} and",
        ...
        Spectral={
            c_ankh={
                ...
                text={
                    "Create a copy of a",
                    "random {C:attention}Jorker{}, destroy",
                    "all other Jokners",
                },
            },
            c_aura={
            ...
            c_soul={
                name="The Soul",
                text={
                    "{C:legendary,E:1}Summons a Mentally Unstable Woman{}",
                },
            },
            c_talisman={
                name="Phantom Tax Return",
                text={
        ...
        Stake={
            stake_black={
                name="Black Stake",
                text={
                    "I WILL {C:attention}OUTLAST{} YOU",
        ...
        Tarot={
            ...
            c_temperance={
                ...
                text={
                    ...
                    "Jorkers {C:inactive}(Max of {C:money}$#1#{C:inactive})",
                    "{C:inactive}(Currently {C:money}$#2#{C:inactive})",
                },
            },
            c_tower={
            ...
            c_wheel_of_fortune={
                name="The Wheel of Despair",
                text={
                    "{C:green}#1# in #2#{} chance to add",
                    "{C:dark_edition}Foil{}, {C:dark_edition}Holographic{}, or",
                    "{C:dark_edition}Polychrome{} edition",
                    "to a random {C:attention}Jorker",
                },
            },
            c_world={
                name="The WORLD",
    ...
    misc={
        ...
        dictionary={
            ...
            b_set_game="Game",
            b_set_game_vol="Loudness",
            b_set_gamespeed="Game Speed",
            b_set_graphics="Graphics",
            b_set_master_vol="Master Volsume Metr",
            ...
            b_stat_jokers="Jorkers",
            b_stat_planets="planet",
            b_stat_spectrals="funnies",
            b_stat_tarots="goldies",
            ...
            k_drank_ex="Drank!",
            k_duplicated_ex="Hello!",
            k_dwarf_planet="Dongus Amongus",
            k_eaten_ex="Cronch!",
            k_edition="Edition",
        ...
        labels={
            blue_seal="Planet Maker",
            common="eryday",
            eternal="I PERSIST",
            foil="tinfoil",
            gold_seal="Gold Sticky",
            holographic="crinkly",
            legendary="Mentally Unstable",
            locked="Locked",
            negative="Negatory",
            perishable="Nerfed",
            pinned_left="Pinned",
            ...
            polychrome="SHINY!",
            purple_seal="Purple Stinker",
            rare="Ooh!",
            red_seal="Double Down",
            rental="Tax",
            tarot="Thingy",
            uncommon="Erm",
            voucher="Vonker",
        ...
        v_text={
            ch_c_all_eternal={
                "All Jorkers are {C:eternal}Eternal{}",
            },
            ...
            ch_c_set_eternal_ante={
                "When ante {C:attention}#1#{} boss is defeated, all Jorkers become {C:attention}eternal",
            },
